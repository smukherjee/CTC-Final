...
- [ ] CHK003 Are all fields from legacy registers and sample documents mapped to the data model? [Completeness, manual-register-mapping.md]
- [ ] CHK004 Are reporting and audit requirements (pending billing, audit trail) specified? [Completeness, Spec §Reporting]

## Requirement Clarity
- [ ] CHK005 Are field definitions and data types unambiguous for all entities? [Clarity, Spec §Data Model]
...
- [ ] CHK011 Are measurable acceptance criteria defined for each major workflow? [Acceptance Criteria, Spec §Success Criteria]
- [ ] CHK012 Are end-to-end test scenarios (5-10 cycles) required and described? [Acceptance Criteria, Spec §Testing]

## Scenario & Edge Case Coverage
- [ ] CHK013 Are exception flows (e.g., contract expiry, failed uploads, audit log errors) addressed? [Coverage, Spec §Functional Requirements]
- [ ] CHK014 Are all document/field mapping edge cases (e.g., derived fields, optional fields) covered? [Edge Case, manual-register-mapping.md]
...
- [ ] CHK017 Are all dependencies (Tally, Indian law, legacy data) and assumptions documented? [Dependencies, Spec §Assumptions]
