...
def create_location_update(db: Session, location_data: VehicleLocationCreate) -> VehicleLocationModel:
...
def get_location_history_by_lr_id(db: Session, lr_id: int) -> List[VehicleLocationModel]:
